...
import '../constant'
import { AppText, skillsList, workDetail } from '../constant'
...
function Skills() {
  return (
    <div className='mt-10' id="skills">
        ...
        <h1 className='text-[40px] font-bold'>{AppText.Skills}<span className='text-blue-500'>{AppText.Experties}</span></h1>
        </div>
